<?php
/**
 * Extension for adding basic Webpack support to wordpress.
...
class TwigWebpackLoader extends \Twig\Extension\AbstractExtension
{
     ...
     *
     * @param string $entryName name of entry in /dist folder 
     ...
     * 
     * @param string $asset path of asset, relative to /dist folder 
