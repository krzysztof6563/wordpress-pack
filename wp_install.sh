...
function installTimber() {
    ...
    yarn add @symfony/webpack-encore @babel/preset-env webpack webpack-cli --dev sass sass-loader bootstrap@5 browser-sync-webpack-plugin browser-sync file-loader webpack-publish-plugin @babel/core
    yarn add core-js 
